...
const songs = [
    {title: 'Kalapakkaara X Illuminati', artist: 'Feyo,Jeo Paul and Vinayak Sasikumar', src: 'audio1.mp3'},
    {title: 'Aasa Kooda', artist: 'Sai Abhyankkar and Sai Smriti', src: 'audio2.mp3'},
    {title: 'Thatha-Vararu', artist: 'Anirudh Ravichander', src: 'audio3.mp3'}
];
